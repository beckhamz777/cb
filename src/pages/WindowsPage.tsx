          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                <a href="https://github.com/oworinaweviolet1968/CHECKBOOK/releases/latest/download/CHECKBOOK.IMS.msi" download className="w-full md:w-auto px-8 py-5 bg-gradient-to-br from-primary to-primary-container text-white rounded-lg font-headline font-bold text-lg flex items-center justify-center gap-3 active:scale-95 transition-all shadow-lg shadow-primary/10">
              ...
              <div className="p-6 bg-white rounded-lg border-l-4 border-secondary shadow-sm">
                ...
                <ul className="space-y-2 text-on-surface-variant text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    Migrated from ZIP file backups to a highly efficient real-time Delta sync using tables and queries, ensuring instant multi-device syncing with zero data loss.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-secondary flex-shrink-0" />
