          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                <a href="https://github.com/beckhamz777/cb/releases/latest/download/METO.IMS-1.9.msi" download className="w-full md:w-auto px-8 py-5 bg-gradient-to-br from-primary to-primary-container text-white rounded-lg font-headline font-bold text-lg flex items-center justify-center gap-3 active:scale-95 transition-all shadow-lg shadow-primary/10">
                  <Download className="w-6 h-6" />
                  Download for Windows (.msi)
                </a>
                <div className="flex flex-col">
                  <span className="text-on-surface font-bold text-lg">v1.9</span>
            ...
            <div className="space-y-4">
              <div className="p-6 bg-white rounded-lg border-l-4 border-secondary shadow-sm">
                <div className="flex justify-between items-start mb-2">
                  <h4 className="font-bold text-on-surface">Version 1.9 — Major Update</h4>
                  <span className="text-xs text-on-surface-variant bg-surface-container px-2 py-1 rounded">Apr 21, 2026</span>
                </div>
                <ul className="space-y-2 text-on-surface-variant text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-secondary flex-shrink-0" />
                    Implemented GZIP database compression, reducing cloud sync traffic by 70%.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-secondary flex-shrink-0" />
                    Added professional Branded Sale Summary with "CHECKBOOK APP" header.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-secondary flex-shrink-0" />
                    Integrated Invoice Print prompts into the finalization workflow.
                  </li>
                </ul>
              </div>
            </div>
