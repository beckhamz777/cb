          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                <a href="https://github.com/beckhamz777/cb/releases/latest/download/CHECKBOOK.IMS.msi" download className="w-full md:w-auto px-8 py-5 bg-gradient-to-br from-primary to-primary-container text-white rounded-lg font-headline font-bold text-lg flex items-center justify-center gap-3 active:scale-95 transition-all shadow-lg shadow-primary/10">
